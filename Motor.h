...
{ 
    private:
        ...
        static const int arrayReadingSize{4};
        int TPDOBytes[arrayReadingSize]{2, 4, 1, 4};
        ...
        static const int arrayWritingSize{4};
        int RPDOBytes[arrayWritingSize]{2, 2, 1, 4};
    ...
    public:
        void ConfigurePDOs(){
            ...
            this->rxPDO1.SDOwrite(0x04, 0x0000, UNSIGNED8);// set index 0 to 3 (number of variables in PDO)
            ...
            this->txPDO1.SDOwrite(0x04, 0x0000, UNSIGNED8);
